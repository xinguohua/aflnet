...
int main(int argc, char* argv[])
{
  ...
  else if (!strcmp(argv[2], "SNMP")) extract_response_codes = &extract_response_code_SNMP;
  else if (!strcmp(argv[2], "TFTP")) extract_response_codes = &extract_response_codes_tftp;
  else if (!strcmp(argv[2], "NTP")) extract_response_codes = &extract_response_code_NTP;
  else if (!strcmp(argv[2], "DHCP")) extract_response_codes = &extract_response_code_dhcp;
  else if (!strcmp(argv[2], "SNTP")) extract_response_codes = &extract_response_code_SNTP;
